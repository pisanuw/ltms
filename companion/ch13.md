...
fast by the counter trick described in [STUDY-NOTES.md](../STUDY-NOTES.md). BCP
...
This chapter's code lives in [`../src/ltms/cltms.py`](../src/ltms/cltms.py), a
...
In [`cltms.py`](../src/ltms/cltms.py) a clause is represented as a
...
[Exercise 5](../exercises/ch13/README.md) asks whether a fancier `subsumes` that
...
results back into a running [`LTMS`](../src/ltms/core.py):
...
[`../src/ltms/indirect.py`](../src/ltms/indirect.py) as `try_indirect_proof`. To
...
[Exercise 10](../exercises/ch13/README.md) explores the natural refinement -- a
...
runnable `.kb` file ([`../examples/kb/completeness.kb`](../examples/kb/completeness.kb))
...
[`../exercises/ch13/kb/proof_by_cases.kb`](../exercises/ch13/kb/proof_by_cases.kb):
...
[`../exercises/ch13/README.md`](../exercises/ch13/README.md); the runnable parts
are in [`../exercises/ch13/solutions.py`](../exercises/ch13/solutions.py). The
notable ones:
...
- In this repo the whole layer is a few dozen readable lines in
  [`../src/ltms/cltms.py`](../src/ltms/cltms.py): `consensus`, `subsumes`,
