...
Everything below is grounded in [`../src/ltms/jtre.py`](../src/ltms/jtre.py),
...
[`../exercises/ch08/README.md`](../exercises/ch08/README.md); the runnable
demonstrations are in
[`../exercises/ch08/solutions.py`](../exercises/ch08/solutions.py). Six
...
what [`../src/ltms/dds.py`](../src/ltms/dds.py) already implements, so the
...
[`../examples/kb/`](../examples/kb/) (run with
...
engine source to read is [`../src/ltms/jtre.py`](../src/ltms/jtre.py), and its
truth-maintenance core is [`../src/ltms/jtms.py`](../src/ltms/jtms.py).
...
- **JTRE is the JTMS-flavored sibling of LTRE.** Same architecture, simpler TMS.
  When you move to [`../exercises/ch09/`](../exercises/ch09/) and the LTMS
