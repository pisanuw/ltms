---
title: "Ch 4 · Pattern-Directed Inference (TRE)"
...
[`../src/ltms/tre/engine.py`](https://github.com/pisanuw/ltms/blob/main/src/ltms/tre/engine.py). It is about 175 lines,
...
[`../exercises/ch04/`](https://github.com/pisanuw/ltms/tree/main/exercises/ch04/).
...
layer of the project (see [`../src/ltms/terms.py`](https://github.com/pisanuw/ltms/blob/main/src/ltms/terms.py) and
[`../src/ltms/unify.py`](https://github.com/pisanuw/ltms/blob/main/src/ltms/unify.py)).
...
([`../src/ltms/ltre.py`](https://github.com/pisanuw/ltms/blob/main/src/ltms/ltre.py)) keeps TRE's pattern matching but
...
[`../examples/family_tre.py`](https://github.com/pisanuw/ltms/blob/main/examples/family_tre.py) is the canonical TRE
...
[`../exercises/ch04/kb/ancestor.kb`](https://github.com/pisanuw/ltms/blob/main/exercises/ch04/kb/ancestor.kb) expresses
...
[`../src/ltms/dsl.py`](https://github.com/pisanuw/ltms/blob/main/src/ltms/dsl.py)) compiles this to the same engine
...
in [`../exercises/ch04/README.md`](https://github.com/pisanuw/ltms/blob/main/exercises/ch04/README.md), and every
"demonstrated" exercise is a `demo_*` function in
[`../exercises/ch04/solutions.py`](https://github.com/pisanuw/ltms/blob/main/exercises/ch04/solutions.py). Highlights:
...
[`unify`](https://github.com/pisanuw/ltms/blob/main/src/ltms/unify.py), which is Robinson's algorithm with the
...
[`../exercises/ch04/kb/ancestor.kb`](https://github.com/pisanuw/ltms/blob/main/exercises/ch04/kb/ancestor.kb): add a
...
[`../src/ltms/jtre.py`](https://github.com/pisanuw/ltms/blob/main/src/ltms/jtre.py) (JTMS-backed) and
[`../src/ltms/ltre.py`](https://github.com/pisanuw/ltms/blob/main/src/ltms/ltre.py) (LTMS-backed).
